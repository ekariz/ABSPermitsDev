...
$required_docphoto   = isset($docphoto['file_name']) ? '' : 'required';
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group   has-feedback">
                                            ...
                                            <?php
                                             echo make_file_upload_field( 'docidpass', $docidpass, 'ID/Passport', $required_docidpass);
                                            ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group   has-feedback">
                                            ...
                                            <?php
                                             echo make_file_upload_field( 'docphoto', $docphoto, 'Passport Photo', $required_docphoto);
                                            ?>
                                        </div>
                                    </div>
            ...
            success : function(data) {
               ...
               if(data.success==1){
                   swal({
                     ...
                     top.location = '<?php echo  base_url(); ?>Signup/LinkOrcid';
                    });
               }else if(data.success==0){
                  swal({
                    text: data.message,
