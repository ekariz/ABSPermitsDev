...
function make_file_upload_field( $name,$saved_var,$title='', $required='' ){
...
return "<i class=\"fa fa-{$icon}\"> </i><input type=\"file\" id=\"{$name}\" name=\"{$name}\"  onchange=\"upload_files();\" {$required}  data-toggle=\"tooltip\" data-placement=\"top\" title=\"{$_title}\"  > ";
}
